...
def replace_all(artist):
    ...
    for connector in connectors:
        artist = artist.replace(connector, "&").replace(")", "").replace("(", "").replace("\"", "")
...
if __name__ == "__main__":
    billboard_data = pd.read_csv("scraps/billboard_weekly_charts.csv")
    ...
    billboard_data.index.name = "song_id"
    billboard_data.to_csv("datasets/billboard_weekly/billboard_weekly_songs.csv")
